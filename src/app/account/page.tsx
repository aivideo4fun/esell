                    ...
                    <div className="relative flex gap-2">
                      <div className="relative flex-1">
                        ...
                        <input
                          ...
                          className="w-full border border-slate-200 bg-white rounded-2xl pl-10 pr-4 py-3 text-xs font-bold text-slate-900 outline-none focus:border-emerald-500 transition shadow-2xs disabled:bg-slate-100 disabled:text-slate-500 disabled:cursor-not-allowed"
                        />
                      </div>
